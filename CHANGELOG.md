...
The methodology release. Reframed the project as a piece of speculative cartography in the spirit of Solnit's *Infinite City* and gave the analytical layer enough rigour to defend at academic standards. Switched the rendering layer from PUMA-level choropleth to tract-level dot density. Cohort taxonomy revised down to six named archetypes.
